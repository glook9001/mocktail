...
bool MergePerformanceClientSettingsOverrides(const PerformancePolicy& policy,
  ...
  if ((policy.multithreaded_rendering || throughput_mode) &&
    ...
    const std::array<ClientSetting, 77> rendering_settings = {{
        ...
        {"FFlagRenderEnableLowEndLOD", "False"},
        ...
        {"FIntLuauGcStepMultiplier", "250"},
        {"FIntLuauGcGoalRatio", "120"},
        ...
        {"FIntTerrainGpuMeshMemoryTargetMib", "8"},
        {"FIntAvatarMeshMemoryMax", "16777216"},
        {"FIntSmoothTerrainPhysicsCacheSize", "8"},
        ...
        {"FIntSlimContentProviderForceCacheSize", "32"},
        {"FIntInitialAudioAssetCacheSize", "16"},
        {"FIntAvatarTextureMemoryMax", "16777216"},
        ...
        {"FIntRenderShadowMapDepthCacheMemLimit", "4"},
        ...
        {"FIntLuauGcStartupWorkingSetMb", "48"},
        {"FIntLuaGcMaxKb", "131072"},
        {"FIntTaskSchedulerMaxTempArenaSizeBytes", "8388608"},
        {"FFlagLocalStorageArenaOptimization", "True"},
        {"FIntProjectedMaxBytesUsedForSoundsMB", "16"},
        {"FIntAudioMetadataCacheSizeKB", "1024"},
