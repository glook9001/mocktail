...
bool MergePerformanceClientSettingsOverrides(const PerformancePolicy& policy,
  ...
  if ((policy.multithreaded_rendering || throughput_mode) &&
    ...
    const std::array<ClientSetting, 78> rendering_settings = {{
        ...
        {"FFlagRenderTextureCompositorLowRes", "True"},
        {"FIntRenderTextureMipBias", quality_str == "1" ? "1" : "0"},
        {"FFlagSimRuntimeContentTranscodeBlockingCall", "False"},
        {"FFlagRenderEnableLowEndLOD", "True"},
        {"FIntTerrainArraySliceSize", "2"},
        ...
        {"FIntLuauGcStepMultiplier", "300"},
        {"FIntLuauGcGoalRatio", "110"},
        ...
        {"FFlagRenderEnableTextureFormatBC7", "True"},
        ...
        {"FFlagAdaptiveMeshCacheSizeForAndroid", "False"},
        {"FIntDefaultMeshCacheSizeMB", "32"},
        {"FIntRenderMeshOrphanBudgetMB", "4"},
        {"FIntTerrainGpuMeshMemoryTargetMib", "4"},
        {"FIntAvatarMeshMemoryMax", "8388608"},
        {"FIntSmoothTerrainPhysicsCacheSize", "4"},
        {"FIntRenderTextureTotalBudgetMB", "64"},
        {"FIntRenderTextureOrphanBudgetMB", "4"},
        {"FFlagDebugTerrainVTCompressedTextures", "True"},
        {"FFlagStreamingObserverMemoryOptimization", "True"},
        {"FIntNetworkStreamingGCMaxMicroSecondLimit", "1500"},
        ...
        {"FIntMeshContentProviderForceCacheSize", "32"},
        {"FIntSlimContentProviderForceCacheSize", "16"},
        {"FIntInitialAudioAssetCacheSize", "8"},
        {"FIntAvatarTextureMemoryMax", "8388608"},
        ...
        {"FIntRenderShadowMapDepthCacheMemLimit", "2"},
        {"FFlagRenderEnableVolumetricCloud", "False"},
        {"FIntTM2ShadowMapMaxMips", "1"},
        {"FIntDebugForceMSAASamples", "1"},
        {"FFlagLuauStartupGcSuppression", "False"},
        {"FIntLuauGcStepMul", "350"},
        {"FIntLuauGcGoalCore", "110"},
        {"FIntLuauGcStartupWorkingSetMb", "32"},
        {"FIntLuaGcMaxKb", "65536"},
        {"FIntTaskSchedulerMaxTempArenaSizeBytes", "4194304"},
        {"FFlagLocalStorageArenaOptimization", "True"},
        {"FIntProjectedMaxBytesUsedForSoundsMB", "8"},
        {"FIntAudioMetadataCacheSizeKB", "512"},
        {"FIntDefaultAudioDecodeBufferSizeMs", "20"},
        {"FIntMaxAudibleSoundChannels", "32"},
        {"FFlagLuauNativeCodeGen", "False"},
        {"FFlagLuauNativeCodeGenMode2", "False"},
