...
bool MergePerformanceClientSettingsOverrides(const PerformancePolicy& policy,
  ...
  if ((policy.multithreaded_rendering || throughput_mode) &&
    ...
    const std::string mip_bias = (quality_str == "1") ? "1" : "0";

    const std::array<ClientSetting, 71> rendering_settings = {{
        ...
        {"FIntRenderTextureMipBias", mip_bias},
        ...
        {"FIntAssetProviderAssetCacheReadThreadCount", "2"},
        {"FIntAssetProviderAssetCacheWriteThreadCount", "2"},
        {"FIntMeshContentProviderForceCacheSize", "256"},
        {"FIntSlimContentProviderForceCacheSize", "128"},
        {"FIntInitialAudioAssetCacheSize", "64"},
        {"FIntAvatarTextureMemoryMax", "67108864"},
        ...
        {"FIntLuauGcStepMul", "200"},
        {"FIntLuauGcGoalCore", "150"},
        {"FIntLuauGcStartupWorkingSetMb", "64"},
        {"FIntLuaGcMaxKb", "524288"},
