...
bool MergePerformanceClientSettingsOverrides(const PerformancePolicy& policy,
  ...
  if ((policy.multithreaded_rendering || throughput_mode) &&
    ...
    const std::array<ClientSetting, 77> rendering_settings = {{
        ...
        {"FIntTerrainGpuMeshMemoryTargetMib", "16"},
        {"FIntAvatarMeshMemoryMax", "33554432"},
        {"FIntSmoothTerrainPhysicsCacheSize", "16"},
        {"FIntRenderTextureTotalBudgetMB", "192"},
        ...
        {"FIntTextureCompositorMeshCache", "8"},
        ...
        {"FIntMeshContentProviderForceCacheSize", "128"},
        ...
        {"FIntRenderShadowMapDepthCacheMemLimit", "8"},
